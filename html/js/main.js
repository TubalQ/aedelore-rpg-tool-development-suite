...
async function checkAndSaveToCloud() {
    ...
    try {
        ...
        const res = await apiRequest(`/api/characters/${currentCharacterId}`, {
            method: 'PUT',
...
async function saveToServer(skipReload = false) {
    ...
    try {
        ...
        if (currentCharacterId) {
            ...
            res = await apiRequest(`/api/characters/${currentCharacterId}`, {
                method: 'PUT',
                body: JSON.stringify({ name: characterName, data, system })
            });
        } else {
            // Create new character
            res = await apiRequest('/api/characters', {
                method: 'POST',
                body: JSON.stringify({ name: characterName, data, system })
            });
        }
...
async function loadTrashCharacters() {
    ...
    try {
        const res = await apiRequest('/api/trash/characters');
...
async function restoreCharacter(id) {
    try {
        const res = await apiRequest(`/api/trash/characters/${id}/restore`, {
            method: 'POST'
        });
...
async function permanentDeleteCharacter(id, name) {
    ...
    try {
        const res = await apiRequest(`/api/trash/characters/${id}`, {
            method: 'DELETE'
        });
...
async function loadCharacterById(id) {
    try {
        const res = await apiRequest(`/api/characters/${id}`);
...
async function linkCharacterToCampaign() {
    ...
    try {
        const res = await apiRequest(`/api/characters/${currentCharacterId}/link-campaign`, {
            method: 'POST',
...
async function loadPartyMembers() {
    ...
    try {
        const res = await apiRequest(`/api/characters/${currentCharacterId}/party`);
...
async function archiveCurrentQuestItem() {
    ...
    try {
        const response = await apiRequest(`/api/characters/${currentCharacterId}/archive-item`, {
            method: 'POST',
...
async function unarchiveQuestItem(archiveIndex) {
    ...
    try {
        const response = await apiRequest(`/api/characters/${currentCharacterId}/unarchive-item`, {
            method: 'POST',
...
async function lockRaceClass() {
    ...
    try {
        const res = await apiRequest(`/api/characters/${currentCharacterId}/lock-race-class`, {
            method: 'POST'
        });
...
async function lockAttributes() {
    ...
    try {
        ...
        if (xpSpendingMode && pointsAdded > 0) {
            ...
            const spendRes = await apiRequest(`/api/characters/${currentCharacterId}/spend-attribute-points`, {
                method: 'POST',
        ...
        const res = await apiRequest(`/api/characters/${currentCharacterId}/lock-attributes`, {
            method: 'POST'
        });
...
async function lockAbilities() {
    ...
    try {
        const res = await apiRequest(`/api/characters/${currentCharacterId}/lock-abilities`, {
            method: 'POST'
        });
